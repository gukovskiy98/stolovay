...
(function () {
  ...
  6: [function (require, module, exports) {
    ...
    var loadheader = require("./modules/loadheader");
  ...
  8: [function (require, module, exports) {
    ...
    function loadheader() {
      if (window.innerWidth <= 900) {
        ...
        var searchForm = document.querySelector('#search-form-mobile');
        var searchLabel = searchForm.querySelector('.page-header-mobile__search-label');
        var searchWrapper = document.querySelector('.page-header-mobile__search-wrapper');
        var modalWrapper = document.querySelector('.page-header-mobile__bottom');
        var opener = modalWrapper.querySelector('.page-header-mobile__modal-opener');
        var modal = modalWrapper.querySelector('.page-header-mobile__modal');
        var closer = modalWrapper.querySelector('.page-header-mobile__modal-closer');
        ...
        searchLabel.addEventListener('click', function () {
          return searchWrapper.classList.toggle('search-opened');
        });
        document.addEventListener('mousedown', function (evt) {
          if (!evt.target.closest('.page-header-mobile__search') && searchWrapper.classList.contains('search-opened')) {
